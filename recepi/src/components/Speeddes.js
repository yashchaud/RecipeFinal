...
const Speeddes = () => {
  ...
  const getRecipes = async () => {
		const res = await axios('http://127.0.0.1:8080/search');
...
const Card = styled(motion.div)`
  ...
  padding: 1rem;
  min-width: 50%;
  box-shadow: rgba(0, 0, 0, 0.25) -1px 54px 55px, rgba(0, 0, 0, 0.12) 0px -12px 30px, rgba(0, 0, 0, 0.12) 0px 4px 6px, rgba(0, 0, 0, 0.17) 0px 12px 13px, rgba(0, 0, 0, 0.09) 0px -3px 5px;
