...
const Div = forwardRef((props , ref) => {
 ...
 const Animation = () => {
  ...
  t1.current = gsap.timeline({defaults:{ease:'power1.out'}})
   ...
   t1.current.fromTo(divre.current,{clipPath:"polygon(10% 10%, 90% 10%, 90% 90%, 10% 90%)"},{width:"120rem",height:"100%",clipPath:"polygon(0% 0%, 100% 0%, 100% 100%, 0% 100%)",ease:"none",duration:1})
